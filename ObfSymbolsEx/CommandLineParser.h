...
struct CommandLineOptions {
    std::wstring inputPath;   // argv[1]: .pdb/.exe/.dll
...
// repeated any number of times, in any order. WORD may optionally be
// wrapped in double quotes ("WORD"), which are stripped.
